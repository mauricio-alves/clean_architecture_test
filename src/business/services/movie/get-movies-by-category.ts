...
@injectable()
export class GetMoviesByCategory extends BaseGetByCategoryUseCase<Movie, GetMovieDTO> implements IGetMoviesByCategoryUseCase {
  constructor(
  ...
  protected toEntityList(dtos: GetMovieDTO[]): Movie[] {
